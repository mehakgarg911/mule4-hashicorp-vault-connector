package org.mule.extension.mule.hashicorp.vault;
...
@org.junit.Ignore("Disabled in environments without Docker")
public class HashicorpConnectionTestCase extends MuleArtifactFunctionalTestCase {
    ...
    private static final String VAULT_TOKEN = "[ENTER VAULT TOKEN]";
	CoreEvent response;

	//These have to match these value in src/test/resources/local.yaml file
	static String expectedValue = "[ENTER PASSWORD]";
	static String vaultKey = "example.password";
	static String vaultKeyAndValue = "example.password=[ENTER PASSWORD]";
